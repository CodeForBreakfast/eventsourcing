...
export default {
  forbidden: [
    ...
    },
    {
      ...
      from: {
        ...
        pathNot: [
          ...
          'tailwind[.]config[.](?:js|cjs|mjs|ts|cts|mts)$', // Tailwind config
          ...
          'packages/[^/]+/src/(?!index[.]ts$).*[.]ts$', // Implementation files in src/ (but not src/index.ts) - accessed through barrel exports
        ],
      },
      to: {},
    },
    ...
    },
    {
      ...
      comment:
        ...
        'version of that module, or find an alternative. Check out https://www.npmjs.com/package/[the package name] ' +
        'and check the orange deprecation banner.',
      severity: 'warn',
      from: {},
      to: {
    ...
    },
    {
      ...
      comment:
        ...
        'module: add it to your package.json. In all other cases you likely have to change the path of the import.',
      severity: 'error',
      from: {},
      to: {
    ...
    },
    {
      ...
      comment:
        ...
        'responsibility anymore. Factor it out into a separate module.',
      severity: 'error',
      from: {},
      to: {
    ...
    },
    {
      ...
      from: {
        path: '^packages/',
        pathNot: ['[.](?:spec|test)[.](?:js|mjs|cjs|jsx|ts|mts|cts|tsx)$', '^packages/.*/tests?/'],
      },
      to: {
  ...
  options: {
    ...
    reporterOptions: {
      ...
      archi: {
        collapsePattern:
          '^(?:packages|src|lib|app|bin|test(?:s)?)/[^/]+|node_modules/(?:@[^/]+/[^/]+|[^/]+)',
      },
      text: {
